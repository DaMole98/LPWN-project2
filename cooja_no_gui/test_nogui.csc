...
<simconf>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.7408685915853428 0.0 0.0 1.7408685915853428 159.1353941881192 168.87117643352516</viewport>
    </plugin_config>
    <width>392</width>
    <z>3</z>
    <height>478</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>SIM_SETTLING_TIME = 1000
        ...
        outputs = new FileWriter("test_nogui.log");
        dcoutputs = new FileWriter("test_nogui_dc.log");
